      		...
      		<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                            Fechas sin programar para revisión de documentos
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    $conexion=new PDO("mysql:host=localhost;dbname=cointic_preveer2","cointic_dbIntal","+ZsntqoVuVh0");
										$consulta=$conexion->query("SELECT asignaInmueble.idAsignacion, CentrosDeTrabajo.nombre FROM asignaInmueble JOIN CentrosDeTrabajo ON CentrosDeTrabajo.idCentroTrabajo=asignaInmueble.idCentroTrabajo JOIN AnalistaOti ON AnalistaOti.idAsignacion=asignaInmueble.idAsignacion WHERE asignaInmueble.idAsignacion NOT IN (SELECT VisitasInmueble.idAsignacion FROM VisitasInmueble WHERE VisitasInmueble.tipoVisita=2 ) and AnalistaOti.idUsuario=$usuario");
										//$datos=array();
                                    $contador=1;
	  ...
	  <div class="modal fade" id="myModalfechaini" role="dialog">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Por favor indique la fecha de revisión de documentos. <p id="nombreTitul"></p></h4>
            </div>
            ...
            <div class="modal-body">
             <div align="center" class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="form-line">
                            <label for="Tt">Próxima fecha de revisión </label>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="form-line">
                      ...
                      <input type="text" class="form-control" id="coments" name="coments" placeholder="Comentario fecha de revisión" required>
                    </div>
                  </div>
                </div>
             </div>
      ...
      function AgendarCita()
        {
          ...
          if (fechaVisita!="") {
                $.ajax({
                  url : "insertaFechasdocumento.php",
                    type: "POST",
                    data: parametro,
                    dataType: "HTML",
                success: function(data)
      		...
      		<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Fechas sin programar para revición de documentos
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $conexion=new PDO("mysql:host=localhost;dbname=cointic_preveer2","cointic_dbIntal","+ZsntqoVuVh0");
										$consulta=$conexion->query("SELECT CentrosDeTrabajo.nombre,asignaInmueble.fechaEntrega,asignaInmueble.idAsignacion FROM AnalistaOti JOIN asignaInmueble ON AnalistaOti.idAsignacion= asignaInmueble.idAsignacion JOIN CentrosDeTrabajo ON asignaInmueble.idCentroTrabajo = CentrosDeTrabajo.idCentroTrabajo WHERE AnalistaOti.idUsuario=$usuario");
										$datos=array();
										foreach ($consulta as $row)
										{
										 ...
										 echo "
                                            <tr>
                                                <td>1</td>
                                                <td><a href='#' data-toggle='modal' data-target='#myModalfechaini'>$nombreCentro</a></td>
                                                <td>
                                                    <a data-toggle='modal' data-target='#myModalfechaini'><i class='fa fa-calendar-check-o'></i></a>
                                                </td>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">#</th>
                          <th scope="col">Fechas de revisión de documentos</th>
                        </tr>
                      </thead>
                      <tbody id="listadoVis">
