        ...
        <div class="card">
            ...
            <div class="panel-group full-body" id="accordion_19" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-col-lightgray">
                    ...
                    $getDatosCentro=$conexion->query("SELECT CentrosDeTrabajo.nombre,CentrosDeTrabajo.idDet FROM CentrosDeTrabajo where CentrosDeTrabajo.idCentroTrabajo=$idCentroTrabajo")->fetchAll(PDO::FETCH_ASSOC);

                    $idDet="";
                    $nombreCen="";


                    foreach ($getDatosCentro as $geD)
                    {
                        $idDet=$geD['idDet'];
                        $nombreCen=$geD['nombre'];
                    }

                    $getUser=$conexion->query("SELECT * FROM Usuario where idUsuario=$idUsuarioBase")->fetchAll(PDO::FETCH_ASSOC);


                    foreach ($getUser as $geU)
                    {
                        $nombreU=$geU['nombre'];
                    }
                    ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <b>No. de sucursal</b>
                                            <input type="text" class="form-control" id="idDet" name="idDet" value="<?=$idDet?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <b>Nombre sucursal</b>
                                            <input type="text" class="form-control" id="nombreSucu" name="nombreSucu" value="<?=$nombreCen?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" class="form-control" id="responsaInspec" name="responsaInspec" value="<?=$idUsuarioBase?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <table id="tabla-oportunidades" class="table table-hover">
...

                    {
                        ...
                        print "<tr><td>$contador</td><td>".$item['area']."</td><td>".$item['factorRiesgo']."</td><td><button type=\"button\" class=\"btn btn-default\" onclick=\"modalFotosMalas(".$item['idOMSSH'].")\"><i class=\"fa fa-picture-o\" aria-hidden=\"true\"></i></button></td><td>".$item['oportunidadMejora']."</td>
                                    ...
                                    <td>".$item['fechaEjecucion']."</td><td>".$item['fechaVerificacion']."</td><td><button type=\"button\" class=\"btn btn-default\" onclick=\"modalFotosBuenas(".$item['idOMSSH'].")\"><i class=\"fa fa-picture-o\" aria-hidden=\"true\"></i></button></td><td>".$item['seguimiento']."</td><td onclick='confirmaDeleteOM(".$item['idOMSSH'].");'><a href='#'>Eliminar</a></td><td style='display: none;'>".$item['idOMSSH']."</td></tr>";
...
function confirmaDeleteOM(idOM)
    {
        ...
        }, function (isConfirm)
        {
            ...
            {
                $.ajax({
                    url: 'https://cointic.com.mx/preveer/sistema/index.php/CrudOMSSH/borrarOM/' + idOM,
                    contentType: false,
                    processData: false,
                    type: 'POST',
                    dataType: 'HTML',
