...
$existencia=$conexion->query("SELECT actaVerificacion.*, Formato.razonSocial, Formato.rfc,
                                ...
                                WHERE asignaInmueble.idAsignacion = $idAsignacion;")->fetchAll(PDO::FETCH_ASSOC);
$catalogo=$conexion->query("SELECT CatalogoHidraulica.* FROM CatalogoHidraulica")->fetchAll(PDO::FETCH_ASSOC);
$contador=0;
...
if($contador==0)
{
    $conexion->query("INSERT INTO actaVerificacion (idAsignacion) VALUES ($idAsignacion)");
    $existencia=$conexion->query("SELECT actaVerificacion.*,Formato.razonSocial,Formato.rfc,Formato.domicilioFiscal FROM actaVerificacion 
                                 JOIN asignaInmueble ON actaVerificacion.idAsignacion=asignaInmueble.idAsignacion join CentrosDeTrabajo on CentrosDeTrabajo.idCentroTrabajo=asignaInmueble.idCentroTrabajo JOIN Formato on Formato.idFormato=CentrosDeTrabajo.idFormato
                                 WHERE asignaInmueble.idAsignacion= $idAsignacion")->fetchAll(PDO::FETCH_ASSOC);
}
$tiposPuente=$conexion->query("SELECT * FROM actaPuente where idAsignacion= $idAsignacion")->fetchAll(PDO::FETCH_ASSOC);
$tiposPuenteEvi=$conexion->query("SELECT * FROM actaPuenteEvi where idAsignacion= $idAsignacion")->fetchAll(PDO::FETCH_ASSOC);
$tiposPuenteInca=$conexion->query("SELECT * FROM actaIncaPuente where idAsignacion= $idAsignacion")->fetchAll(PDO::FETCH_ASSOC);
?>
            ...
            <div class="body">
                ...
                <div class="panel-body">
                    <form id="form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <p>En <input type="text" id="ciudMuni" name="ciudMuni" value="<?php echo $row['ciudadEstado']; ?>"> , siendo las <input type="text" id="horaU" name="horaU" value="<?php echo $row['hora']; ?>">, del día <input type="text" name="fechaU" id="fechaU" value="<?php echo $row['fechaU']; ?>">, se reunieron los integrantes de la Comisión de Seguridad e Higiene en el interior de las instalaciones de la empresa <input type="text" id="razonSocia" name="razonSocia" style="width: 40%;" value="<?php echo $row['razonSocial']; ?>"> con Registro Federal de Contribuyentes <input type="text" id="rfcC" name="rfcC" value="<?php echo $row['rfc']; ?>">  y Registro Patronal <input type="text" id="regiPatro" name="regiPatro" value="<?php echo $row['registroPatronal']; ?>"> , cuya actividad consiste en <input type="text" id="descripcEmp" style="width: 30%;"name="descripcEmp" value="<?php echo $row['descripcionEmpresa']; ?>"> y cuenta con una plantilla de <input type="text" id="nEmple" name="nEmple" value="<?php echo $row['nEmpleado']; ?>"> trabajadores, con domicilio en <input type="text" id="domiFisc" style="width: 60%;" name="domiFisc" value="<?php echo $row['domicilioFiscal']; ?>"> Y <input type="text" id="cp" name="cp" value="<?php echo $row['CP']; ?>"> a efecto de realizar el recorrido de verificación, conforme a lo dispuesto en los artículos 509, 510 y 540 de la Ley Federal del Trabajo; Artículo 45, I, II, III, IV, V, VI,VII,VII, IX, X del Reglamento Federal de Seguridad y Salud en el Trabajo,  la NOM-19-STPS-2011. </p>
                        </div>
                    </form>
                    <!-- <form id="form2"  > -->
                                    ...
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" id="puntoRevi" name="puntoRevi" min="1" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                <b>Area</b>
                                                <input type="text" class="form-control" id="areaRe" name="areaRe" min="0" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" id="puntNom" name="puntNom" min="0" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="row text-center">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-line">
                                                <input type="submit" onclick="AgregarPuntos()" value="Agregar" class="btn bg-red" id="agregar-in">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" id="condicionesEv" name="condicionesEv" min="1" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                <b>Área</b>
                                                <input type="text" class="form-control" id="areaEvi" name="areaEvi"  required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                <b>Recomendaciones para prevenir las condiciones inseguras detectadas</b>
                                                <input type="text" class="form-control" id="recomEvid" name="recomEvid" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" id="responsableEvi" name="responsableEvi"  value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" id="fechaAviEvi" name="fechaAviEvi" min="0" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6"  >
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" id="fechaFevid" name="fechaFevid" value="" required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row text-center">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-line">
                                                    <input type="submit" onclick="AgregarEvidencia()" value="Agregar" class="btn bg-red" id="agregar-in">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th>Área</th>
                                                <th>Recomendaciones para prevenir las condiciones inseguras detectadas</th>
                    ...
                    <div class="body table-responsive col-sm-12"  >
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <select  class="form-control" id="tipoIncap" name="tipoIncap"  >
                                            ...
                                            <option value="Enfermedades de trabajo">Enfermedades de trabajo</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2"  >
                                <div class="form-group">
                                    <div class="form-line">
                                        <b>No.</b>
                                        <input type="number" class="form-control" id="noInca" name="noInca" value="1" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4"  >
                                <div class="form-group">
                                    <div class="form-line">
                                        <b>Área</b>
                                        <input type="text" class="form-control" id="areaInca" name="areaInca" value="" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4"  >
                                <div class="form-group">
                                    <div class="form-line">
                                        <b>Fecha y hora</b>
                                        <input type="text" class="form-control" id="FehInca" name="FehInca" value="" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4"  >
                                <div class="form-group">
                                    <div class="form-line">
                                        <b>Acto Inseguro</b>
                                        <input type="text" class="form-control" id="actpInseIn" name="actpInseIn" value="" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4"  >
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" class="form-control" id="condicionInca" name="condicionInca" value="" required/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="row text-center">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-line">
                                        <input type="submit" onclick="AgregarIncap()" value="Agregar" class="btn bg-red" id="agregar-in">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <p>No existiendo otro asunto que tratar, se dio por terminada la presente, siendo las <input type="text" id="hodrDos" name="hodrDos" value="<?php echo $row['horaDos']; ?>" form="form"> horas del <input type="text" id="fechDos" name="fechDos" value="<?php echo $row['fechaDos']; ?>" form="form">, Firmando de conformidad al calce y margen los que en ella intervinieron.</p>
                    </div>
                    ...
                    <div class=" col-md-offset-3 col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="reprePatronCor" name="reprePatronCor" value="<?php echo $row['reprePatronCor']; ?>" form="form" />
                            </div>
                    ...
                    <div class="col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="reprePatroSecrer" name="reprePatroSecrer" value="<?php echo $row['reprePatroSecrer']; ?>" form="form" />
                            </div>
                ...
                <div class="row">
                    <div class=" col-md-offset-3 col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="reprePatronVocal" name="reprePatronVocal" value="<?php echo $row['reprePatronVocal']; ?>" form="form" />
                            </div>
                    ...
                    <div class="col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="repreTrabaVocal" name="repreTrabaVocal" value="<?php echo $row['repreTrabaVocal']; ?>" form="form" />
                            </div>
                ...
                <div class="row">
                    <div class=" col-md-offset-3 col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="reprePatronVocalDos" name="reprePatronVocalDos" value="<?php echo $row['reprePatronVocalDos']; ?>" form="form" />
                            </div>
                            <p>Representante del Patrón (Vocal)</p>
                        </div>
                    </div>
                    <div class="col-sm-3"  >
                        <div class="form-group" >
                            <div class="form-line" align="center">
                                <input type="text" class="form-control" id="RepreTrabaVocalDos" name="RepreTrabaVocalDos" value="<?php echo $row['RepreTrabaVocalDos']; ?>" form="form" />
                            </div>
                            <p>Representante de los trabajadores (Vocal)</p>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-2 col-md-offset-4 col-xs-offset-4 col-xs-4">
                            <div class="form-line">
                                <input type="submit" onclick="registrarActaGral();" class="btn bg-red waves-effect waves-light"  value="Guardar" >
                            </div>
                        </div>
