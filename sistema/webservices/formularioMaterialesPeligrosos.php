                    ...
                    <div class="body">
                        <form id="form2">
                            ...
                            <div class="panel-group full-body" id="accordion_18" role="tablist" aria-multiselectable="true">
                                ...
                                $contador=0;
                                $existencia=$conexion->query("SELECT MaterialPeligroso.* FROM MaterialPeligroso JOIN asignaInmueble ON MaterialPeligroso.idAsignacion=asignaInmueble.idAsignacion WHERE asignaInmueble.idAsignacion=$idAsignacion");
                                $existenciaSustancias=$conexion->query("SELECT SustanciasQuimicas.* FROM SustanciasQuimicas JOIN asignaInmueble ON SustanciasQuimicas.idAsignacion=asignaInmueble.idAsignacion WHERE asignaInmueble.idAsignacion=$idAsignacion");
                                ...
                                if($contador==0)
                                {
                                    ...
                                    $insercion=$conexion->prepare("INSERT INTO MaterialPeligroso(fechaVisita, idAsignacion) VALUES (?,?)");
                                    $insercion->bindParam(1, date("Y-m-d"));
                                    $insercion->bindParam(2, $idAsignacion);
                                    $insercion->execute();
                                    $existencia=$conexion->query("SELECT MaterialPeligroso.* FROM MaterialPeligroso JOIN asignaInmueble ON MaterialPeligroso.idAsignacion=asignaInmueble.idAsignacion WHERE asignaInmueble.idAsignacion=$idAsignacion");
                                }
                                $GasPuente=$conexion->query("SELECT * FROM MaterialPeliPuente WHERE idAsignacion = $idAsignacion");
    ...
    function registrarDatosSustanciasQuimicas()
    {
        ...
        $.post({
            ...
            success: function(data)
            {
                ...
                swal({
                        title: "Éxito",
                        text: "Se han registrado los materiales peligrosos",
                        type: "success",
