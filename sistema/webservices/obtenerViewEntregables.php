                            ...
                            $porcentajeValor=$row["porcentajeValor"];
                                ...
                                echo "
                                     <tr>
                                        ...
                                        <td>
                                            <a href='#' onclick='asignaEntregables($idAsignacion)'><i class='fa fa-files-o'></i> </a>
                                        </td>
                                    </tr>";
...
<div class="modal fade" id="myModalEntregables" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Entregables del centro de trabajo.</h4>
            </div>
            <div class="modal-body">
