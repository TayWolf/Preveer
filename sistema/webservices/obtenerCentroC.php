      		...
      		<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Visitas con fechas programadas
                    ...
                    $consulta=$conexion->query("SELECT asignaInmueble.idAsignacion, CentrosDeTrabajo.nombre FROM asignaInmueble JOIN CentrosDeTrabajo ON CentrosDeTrabajo.idCentroTrabajo=asignaInmueble.idCentroTrabajo JOIN AnalistaOti ON AnalistaOti.idAsignacion=asignaInmueble.idAsignacion WHERE asignaInmueble.idAsignacion IN (SELECT VisitasInmueble.idAsignacion FROM VisitasInmueble WHERE VisitasInmueble.tipoVisita=1) and AnalistaOti.idUsuario=$usuario");
                    //$datos=array();
