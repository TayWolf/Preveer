        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body table-responsive">
                        ...
                        foreach ($consulta as $row)
                        {
                            ...
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='javascript:formSubmit($idOti, $idAsignacion, $idCentroTrabajo);'><i class='fa fa-briefcase'></i></a>
                                    </td>
                                </tr>";
                            }
                    ...
                    <form id="#formulario" action="viewAcuseVisita.php" method="POST">
                        <input name="idOti" id="idOti" type="hidden">
                        <input name="idAsignacion" id="idAsignacion" type="hidden">
                        <input name="idCentroTrabajo" id="idCentroTrabajo" type="hidden">
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function formSubmit(idOti, idAsignacion, idCentroTrabajo)
    {
        $("#idOti").val(idOti);
        $("#idAsignacion").val(idAsignacion);
        $("#idCentroTrabajo").val(idCentroTrabajo);
