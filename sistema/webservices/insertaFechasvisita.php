...
$consulta=$conexion->query("INSERT INTO VisitasInmueble(idAsignacion, fechaAgenda, Status, fechaAplicacion, tipoVisita, comentario) VALUES ($idIdentif,'$fechaVisita',0,'0000-00-00',1,'$coments')");
 ?>