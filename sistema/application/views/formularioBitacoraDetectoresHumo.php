                    ...
                    <div class="body">
                        ...
                        <form id="form">
                            ...
                            <div class="panel-group full-body" id="accordion_18" role="tablist" aria-multiselectable="true">
                                ...
                                $conexion=new PDO("mysql:host=localhost;dbname=cointic_preveer","cointic_dbIntal","+ZsntqoVuVh0");
                                                        ...
                                                        <div class="form-line">
                                                            ...
                                                            <select class="form-control" id="areaUbicacion" name="areaUbicacion" required>
                                                                ...
                                                                $areasUbicacion=$conexion->query("SELECT * FROM areaClubesSW");
                                                                    if($areasUbicacion):?>
                                                                <?php foreach($areasUbicacion as $row1):?>
                                                                <option value="<?=$row1['idArea']?>"><?=$row1['descripcion']?></option>
                                                                <?endforeach; ?>
                                                                <?php endif;?>
