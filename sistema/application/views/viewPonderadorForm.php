...
<script type="text/javascript">
  ...
  $("#formulario").on("submit", function(e){
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorForm/altaPonderador/';?>";
    e.preventDefault();
    var f = $(this);
                ...
                contentType: false,
                 ...
                 success: function(res)
                 {
                  //  alert(res);
                        ...
                        function(){
                          window.location.assign("https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorForm")
                        });
                 }
            });
