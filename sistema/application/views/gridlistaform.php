...
<script type="text/javascript">
  ...
  // alert("datos"+qq);
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorFormulario/altaPuente/';?>"+total;
    e.preventDefault();
    var f = $(this);
    var formData = new FormData(document.getElementById("form"));
   ...
   <script type="text/javascript">
        function confirmaDeletePuente(id,idI)
       {
           ...
           swal({
            ...
            function(){
              location.href="https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorFormulario/deletePuente/"+id+"/"+idI; 
            });
