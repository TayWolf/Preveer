...
<script type="text/javascript">
   window.onload=CargarDatos;
    ...
    function CargarDatos(){
       ...
       // alert("entra "+idInd)
          $.ajax({
            url : "<?php echo site_url('CrudPonderadorReporte/getDatosPonderador')?>/" + idInd,
            type: "get",
            dataType: "json",
  ...
  $("#contenido").on("submit", function(e){
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorReporte/modificarDatos/';?>";
    e.preventDefault();
    var f = $(this);
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Modificar Ponderador Infraestructura</h2>
                        </div>
                        <div class="body">
