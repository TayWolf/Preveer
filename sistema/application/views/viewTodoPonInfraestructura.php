...
?>
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorInfra/formAltaPonderador">Registrar Ponderador Infraestructura</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body table-responsive">
                            <table class="table table-hover" id="tabla-infraestructura">
                                <thead>
                                <tr>
                                    <th>#</th>
                                ...
                                foreach ($listaPonderador as $row) {
                                    ...
                                    echo "
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorInfra/formEditarPonderador/$idPonderador'><i class='fa fa-pencil-square-o'></i></a>
                                                </td>
    ...
    <script type="text/javascript">
        function confirmaDeletePonderador(id)
        {
            ...
            swal({
                ...
                function(){
                    location.href="https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorInfra/deletePonderador/"+id;
                });
    ...
    <script type="text/javascript">
        ...
        function inicio()
        {
            $('#tabla-infraestructura').dataTable();
        }
    </script>
