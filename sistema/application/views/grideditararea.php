...
<script type="text/javascript">
   window.onload=inicio;
    function inicio(){
        var idu = $("#idArea").val();
          $.ajax({
        url : "<?php echo site_url('Crudareas/obtenerDatos')?>/" + idu,
        type: "get",
        dataType: "JSON",
...
*/
  ...
  $("#form").on("submit", function(e){
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/Crudareas/modificarDatos/';?>";
    e.preventDefault();
    var f = $(this);
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="post" action="" id="form" enctype="multipart/form-data">
                                <h2 class="card-inside-title text-center">Ingrese el nuevo nombre del área </h2>
