...
?>
                    ...
                    <div class="card">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="https://cointic.com.mx/preveer/sistema/index.php/CrudPrioridadIntervencion/formAltaPrioridad">Registrar Prioridad Intervención</a></li>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover" id="tabla-prioridades">
                                ...
                                <tr>
                                    <th>#</th>
                                    <th>Nombre de prioridad de intervencion</th>
                                    <th>Modificar</th>
                                    <th>Eliminar</th>
                                </tr>
                                </thead>
                                ...
                                foreach ($listaprioridad as $row) {
                                    ...
                                    echo "
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='https://cointic.com.mx/preveer/sistema/index.php/CrudPrioridadIntervencion/formEditarPrioridad/$idPrioridad'><i class='fa fa-pencil-square-o'></i></a>
                                                </td>
    ...
    <script type="text/javascript">
        function confirmaDeletePrioridad(id)
        {
            ...
            swal({
                    title: "Aviso",
                    text: "¿Desea borrar esta prioridad Intervención?",
                    type: "warning",
                ...
                function(){
                    location.href="https://cointic.com.mx/preveer/sistema/index.php/CrudPrioridadIntervencion/deletePrioridad/"+id;
                });
