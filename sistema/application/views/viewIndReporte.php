...
<script type="text/javascript">
  ...
  $("#form").on("submit", function(e){
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorReporte/altaIndicador/';?>";
    e.preventDefault();
    var f = $(this);
    ...
    $.ajax({
                ...
                .done(function(res){
                  //alert(res);
                    ...
                    function(){
                        window.history.back();
                      //window.location.assign("https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorReporte")
                    });
