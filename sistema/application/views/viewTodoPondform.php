                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorForm/formAltaPonderador">Registrar Ponderador Infraestructura</a></li>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover" id="tabla-ponderadores">
                                <thead>
                                <tr>
                                    <th>#</th>
                                ...
                                foreach ($listaPonderador as $row) {
                                    ...
                                    echo "
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorForm/formEditarPonderador/$idPonderador'><i class='fa fa-pencil-square-o'></i></a>
                                                </td>
    ...
    <script type="text/javascript">
        function confirmaDeletePonderador(id)
        {
            ...
            swal({
                ...
                function(){
                    location.href="https://cointic.com.mx/preveer/sistema/index.php/CrudPonderadorForm/deletePonderador/"+id;
                });
