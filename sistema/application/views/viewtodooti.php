                            ...
                            <table class="table table-hover" id="tabla-otis">
                                ...
                                <tr>
                                    ...
                                    elseif ($tipoUser==3) {
                                        ...
                                        if ($areaUser==2) {
                                         echo "<th>Inspecciones programadas</th>";
                                        }
										
										echo "<th>Agendar Visita</th>";
										echo "<th>Estado</th>";
                                    } elseif($tipoUser==4){
                                        echo "<th>C/Trabajo</th>";
                                        if($areaUser==2)
                                ...
                                foreach ($listOti as $row) {
                                    ...
                                    if ($tipoUser==1||$tipoUser==3||$tipoUser==5) { //valida que el usuario sea administrador
                                        ...
                                        if ($coordinador>0) //ponde en color verde el botón del coordinador en caso de que ya se haya aignado uno
                                        {
                                            ...
                                            if($analistas>0)
                                            {
                                                $botoAnalista= "<td><a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/cargarAnalistasOti/$idOti'><i class='fa fa-user-circle-o' style='color:green'></i></a></td>";
                                            }
                                            else
                                            {
                                                $botoAnalista= "<td><a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/cargarAnalistasOti/$idOti'><i class='fa fa-user-circle-o' ></i></a></td>";
                                            }
                                    ...
                                    if($tipoUser==2){
                                        $boton= "<td><a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/listCentroTrabajo/$idOti'><i class='fa fa-building-o' style='color:green'></i></a></td>";
                                    }
                                    if ($tipoUser==3) {
                                        
                                        $botonCentroT= "<td><a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/listCentroTrabajo/$idOti'><i class='fa fa-building-o' style='color:green'></i></a></td>";
                                         $botonProgr= "<td> <a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/candelarizacionSSHI/$idOti'><i class='fa fa-calendar' style='color:green'></i></a></td>";
                                        if($analistas>0)
                                        {
									...
									if($tipoUser!=4)
									{
										if($areaUser==1)
											echo "
												<tr>
													...
													<td>$centroTrabajo</td>
													<td>
														<a href='https://cointic.com.mx/preveer/sistema/index.php/CrudOti/formDetalleOti/$idOti'><i class='fa fa-eye'></i></a>
													</td>
													$boton
										...
										if($estado==1) //solo se muestran los estados que estan activos
										echo "
                                            <tr>
                                                <td>$idOti</td>
                                                <td>$nombreCliente</td>
