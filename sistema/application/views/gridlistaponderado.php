...
<script type="text/javascript">
  ...
  // alert("datos"+qq);
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorInfra/altaPuente/';?>"+total;
    e.preventDefault();
    var f = $(this);
    var formData = new FormData(document.getElementById("form"));
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Seleccione los Ponderador </h4>
          </div>
   ...
   <script type="text/javascript">
        function confirmaDeletePuente(id,idI)
       {
           ...
           swal({
            ...
            function(){
              location.href="https://cointic.com.mx/preveer/sistema/index.php/CrudIndicadorInfra/deletePuente/"+id+"/"+idI; 
            });
