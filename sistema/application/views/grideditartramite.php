...
<script type="text/javascript">
   window.onload=inicio;
    function inicio(){
        var idu = $("#idTramite").val();
          $.ajax({
        url : "<?php echo site_url('Crudtramites/obtenerDatos')?>/" + idu,
        type: "get",
        dataType: "JSON",
        ...
        $("#nombreTramite").val(data.nombreTramite);
/*        $("#foto").val(data.Foto);*/
        //$("#tipo").val(data.tipo);
...
*/
  ...
  $("#form").on("submit", function(e){
    ...
    url= "<?php echo 'https://cointic.com.mx/preveer/sistema/index.php/Crudtramites/modificarDatos/';?>";
    e.preventDefault();
    var f = $(this);
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="post" action="" id="form" enctype="multipart/form-data">
                                <h2 class="card-inside-title text-center">Ingrese el nuevo nombre del trámite</h2>
