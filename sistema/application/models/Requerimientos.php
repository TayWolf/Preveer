...
class Requerimientos extends CI_Model{
    public $variable;
  ...
  function getTotalRowAllData()
	{
 		$query = $this->db->query("SELECT count(*) as row FROM Requerimiento")->row_array();
 		return $query['row'];
	}
 ...
 // untuk config class pagination yg lainnya optional (suka2 lu.. :D )
	...
	function insertaDatos($data)
	{
   	...
   	function obtenerFicha ($idRequerimiento){
        return $this->db->query("SELECT * from Requerimiento where idRequerimiento=$idRequerimiento")->row();
   	}
    ...
    { 
      ...
      function modificaDatos($data,$idRequerimiento)
  { 
  ...
  //   }
    ...
    function borrarDatos($idRequerimiento)
  { 
    $this->db->where('idRequerimiento', $idRequerimiento);
