 ...
 */
var identificadorCapacitacion=0;
                ...
                editable: function() {
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            var span = '<span class="tabledit-span" id="span'+identificadorCapacitacion+'">' + text + '</span>';
                            identificadorCapacitacion++;
                            // Check if exists the third parameter of editable array.
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                // Create select element.
                                var input = '<select class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.editable[i][1] + '" id="' + settings.columns.editable[i][1] +idIdenti+ '" style="display: none;" disabled>';
